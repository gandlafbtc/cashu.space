...
const guides = [
  {
    href: '/resources/guides/python-wallet',
    name: 'Cashu Python',
    description:
  ...
  {
    href: '/resources/guides/nutstash',
  ...
  {
    href: '/resources/guides/python-mint',
    name: 'Running a mint',
    description:
  ...
  {
    href: '/resources/guides/nostr',
    name: 'Cashu on Nostr',
    description: 'Learn how to use Cashu on Nostr.',
    icon: CheckIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
